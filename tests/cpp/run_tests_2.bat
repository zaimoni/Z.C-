...
@REM runs regression tests for zcc.exe -E
...
@set ACCEPT_TEST=0
@set CPP=..\..\bin\zcc -E
@set CPP_ISO=..\..\bin\zcc -E --pedantic
@set CPP_SIGNMAG_NOTRAP=..\..\bin\zcc -E --int-sign-magnitude
@set CPP_SIGNMAG_TRAP=..\..\bin\zcc -E --int-sign-magnitude --int-traps
@set CPP_ONESCOMP_NOTRAP=..\..\bin\zcc -E --int-ones-complement
@set CPP_ONESCOMP_TRAP=..\..\bin\zcc -E --int-ones-complement --int-traps
@set CPP_TWOSCOMP_NOTRAP=..\..\bin\zcc -E --int-twos-complement
@set CPP_TWOSCOMP_TRAP=..\..\bin\zcc -E --int-twos-complement --int-traps
